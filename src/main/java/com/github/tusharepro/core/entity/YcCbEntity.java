...
public class YcCbEntity implements YcCb {
  ...
  @Id
  @Column(name = "ts_code")
  protected String tsCode; // 曲线编码
  @Column(name = "curve_name")
  protected String curveName; // 曲线名称
  @Id
  @Column(name = "curve_type")
  protected String curveType; // 曲线类型：0-到期，1-即期
  @Id
  @Column(name = "curve_term")
  protected Double curveTerm; // 期限(年)
  @Column(name = "yield")
  protected Double yield; // 收益率(%)
