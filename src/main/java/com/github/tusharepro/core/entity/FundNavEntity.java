...
public class FundNavEntity implements FundNav {
  ...
  protected LocalDate endDate; // 截止日期
  @Column(name = "unit_nav")
  protected Double unitNav; // 单位净值
  @Column(name = "accum_nav")
  protected Double accumNav; // 累计净值
  @Column(name = "accum_div")
  protected Double accumDiv; // 累计分红
  @Column(name = "net_asset")
  protected Double netAsset; // 资产净值
  @Column(name = "total_netasset")
  protected Double totalNetasset; // 合计资产净值
  @Column(name = "adj_nav")
  protected Double adjNav; // 复权单位净值
