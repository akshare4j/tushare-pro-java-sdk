...
public class MoneyflowHsgtEntity implements MoneyflowHsgt {
  ...
  @Column(name = "ggt_ss")
  protected Double ggtSs; // 港股通（上海）
  @Column(name = "ggt_sz")
  protected Double ggtSz; // 港股通（深圳）
  @Column(name = "hgt")
  protected Double hgt; // 沪股通（百万元）
  @Column(name = "sgt")
  protected Double sgt; // 深股通（百万元）
  @Column(name = "north_money")
  protected Double northMoney; // 北向资金（百万元）
  @Column(name = "south_money")
  protected Double southMoney; // 南向资金（百万元）
