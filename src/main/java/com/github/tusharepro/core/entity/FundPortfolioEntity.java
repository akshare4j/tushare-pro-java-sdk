...
public class FundPortfolioEntity implements FundPortfolio {
  ...
  @Id
  @Column(name = "ts_code")
  protected String tsCode; // TS基金代码
  ...
  @Column(name = "mkv")
  protected Double mkv; // 持有股票市值(元)
  @Column(name = "amount")
  protected Double amount; // 持有股票数量（股）
  @Column(name = "stk_mkv_ratio")
  protected Double stkMkvRatio; // 占股票市值比
  @Column(name = "stk_float_ratio")
  protected Double stkFloatRatio; // 占流通股本比例
