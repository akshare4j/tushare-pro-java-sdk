...
public class DailyBasicEntity implements DailyBasic {
  ...
  @Column(name = "pe")
  protected Double pe; // 市盈率（总市值/净利润， 亏损的PE为空）
  @Column(name = "pe_ttm")
  protected Double peTtm; // 市盈率（TTM，亏损的PE为空）
  @Column(name = "pb")
  ...
  protected Double dvRatio; // 股息率 （%）
  @Column(name = "dv_ttm")
  protected Double dvTtm; // 股息率（TTM）（%）
  @Column(name = "total_share")
  protected Double totalShare; // 总股本 （万股）
  @Column(name = "float_share")
  protected Double floatShare; // 流通股本 （万股）
