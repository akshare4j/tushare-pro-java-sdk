...
public class DividendEntity implements Dividend {
  ...
  protected LocalDate endDate; // 分红年度
  @Column(name = "ann_date")
  protected LocalDate annDate; // 预案公告日
  ...
  protected LocalDate recordDate; // 股权登记日
  @Column(name = "ex_date")
  protected LocalDate exDate; // 除权除息日
  @Column(name = "pay_date")
  protected LocalDate payDate; // 派息日
  @Column(name = "div_listdate")
  protected LocalDate divListdate; // 红股上市日
  @Column(name = "imp_ann_date")
  protected LocalDate impAnnDate; // 实施公告日
  @Column(name = "base_date")
  protected LocalDate baseDate; // 基准日
