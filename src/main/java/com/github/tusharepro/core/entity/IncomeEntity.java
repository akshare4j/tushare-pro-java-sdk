...
public class IncomeEntity implements Income {
  ...
  protected LocalDate fAnnDate; // 实际公告日期，即发生过数据变更的最终日期
  @Id
  @Column(name = "end_date")
  protected LocalDate endDate; // 报告期
  @Id
  ...
  protected Double totalRevenue; // 营业总收入
  @Column(name = "revenue")
  ...
  protected String updateFlag; // 更新标识，0未修改1更正过
