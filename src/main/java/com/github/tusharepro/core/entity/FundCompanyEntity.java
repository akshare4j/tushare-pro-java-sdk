...
public class FundCompanyEntity implements FundCompany {
  ...
  @Id
  @Column(name = "name")
  protected String name; // 基金公司名称
  @Column(name = "shortname")
  protected String shortname; // 简称
  @Column(name = "short_enname")
  protected String shortEnname; // 英文缩写
  ...
  @Column(name = "office")
  protected String office; // 办公地址
  @Column(name = "website")
  protected String website; // 公司网址
  ...
  protected LocalDate setupDate; // 成立日期
  @Column(name = "end_date")
  protected LocalDate endDate; // 公司终止日期
  @Column(name = "employees")
  protected Double employees; // 员工总数
  @Column(name = "main_business")
  protected String mainBusiness; // 主要产品及业务
  @Column(name = "org_code")
  protected String orgCode; // 组织机构代码
