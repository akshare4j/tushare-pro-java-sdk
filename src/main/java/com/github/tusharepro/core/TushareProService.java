...
public interface TushareProService {
  ...
  /*
   * 上市公司管理层 https://tushare.pro/document/2?doc_id=193
   */
  ...
  /*
   * 管理层薪酬和持股 https://tushare.pro/document/2?doc_id=194
   */
  ...
  /*
   * 停复牌信息(停) https://tushare.pro/document/2?doc_id=31
   */
  ...
  /*
   * 港股通每日成交统计 https://tushare.pro/document/2?doc_id=196
   */
  ...
  /*
   * 港股通每月成交统计 https://tushare.pro/document/2?doc_id=197
   */
  ...
  /*
   * 龙虎榜机构明细 https://tushare.pro/document/2?doc_id=107
   */
  ...
  /*
   * 股权质押明细 https://tushare.pro/document/2?doc_id=111
   */
  ...
  /*
   * 概念股分类 https://tushare.pro/document/2?doc_id=125
   */
  ...
  /*
   * 概念股列表 https://tushare.pro/document/2?doc_id=126
   */
  ...
  /*
   * 股票账户开户数据 https://tushare.pro/document/2?doc_id=164
   */
  ...
  /*
   * 股票账户开户数据（旧） https://tushare.pro/document/2?doc_id=165
   */
  ...
  /*
   * 指数月线行情 https://tushare.pro/document/2?doc_id=172
   */
  ...
  /*
   * 申万行业成分构成 https://tushare.pro/document/2?doc_id=182
   */
  ...
  /*
   * 公募基金经理 https://tushare.pro/document/2?doc_id=208
   */
  ...
  /*
   * 期货合约信息表 https://tushare.pro/document/2?doc_id=135
   */
  ...
  /*
   * 每日成交持仓排名 https://tushare.pro/document/2?doc_id=139
   */
  ...
  /*
   * 仓单日报 https://tushare.pro/document/2?doc_id=140
   */
  ...
  /*
   * 结算参数 https://tushare.pro/document/2?doc_id=141
   */
  ...
  /*
   * 期货主力与连续合约 https://tushare.pro/document/2?doc_id=189
   */
  ...
  /*
   * 期货主要品种交易周报 https://tushare.pro/document/2?doc_id=216
   */
  ...
  /*
   * 期货期权TICK数据 本数据归属上海中期期货有限公司，具备该公司交易账号才可以获取 https://tushare.pro/document/2?doc_id=235
   */
  ...
  /*
   * 可转债基本信息 https://tushare.pro/document/2?doc_id=185
   */
  ...
  /*
   * 可转债转股价变动 https://tushare.pro/document/2?doc_id=246
   */
  ...
  /*
   * 财经日历 https://tushare.pro/document/2?doc_id=233
   */
  ...
  /*
   * 港股行情 https://tushare.pro/document/2?doc_id=192
   */
